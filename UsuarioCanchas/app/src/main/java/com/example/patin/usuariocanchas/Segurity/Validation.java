package com.example.patin.usuariocanchas.Segurity;
...
public class Validation {
    ...
    /**
     *
     * @param compare Email to compare using Regular expresion
     * @return if email is acepted
     */
    public static boolean isCorrectEmail(String compare){
        ...
        Pattern emailPattern = Pattern.compile(regularExpresion);
        Matcher match = emailPattern.matcher(compare);
        return match.find();
    }
}
