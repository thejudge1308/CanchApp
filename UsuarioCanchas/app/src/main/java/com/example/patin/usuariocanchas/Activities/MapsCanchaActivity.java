...
public class MapsCanchaActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng curico = new LatLng(Double.parseDouble(lattitude), Double.parseDouble(longitude));
        mMap.addMarker(new MarkerOptions().position(curico).title("Cancha prueba"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(curico,10));
     }
